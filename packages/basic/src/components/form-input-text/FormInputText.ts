...
import type { ValidationMessages, ValidationResult, ValidationTranslator } from '@vue-layout/hyperscript';
import { buildFormInput, buildFormInputText } from '@vue-layout/hyperscript';
